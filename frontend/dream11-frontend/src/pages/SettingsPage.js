      ...
      <div className="p-6">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">Admin Settings</h2>
              <div>
                <a 
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 ml-7">
                  Monitor and manage the data collection, processing, and prediction pipeline
                </p>
              </div>
            </div>
